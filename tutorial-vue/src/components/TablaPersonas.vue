            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="persona in personas" :key="persona.id">
                        ...
                        <td v-if="editando === persona.id">
                            <button class="btn btn-success" data-cy="save-button"
                        ...
                        <td v-else>
                            ...
                            <button class="btn btn-danger ml-2" data-cy="delete-button"
                                @click="$emit('delete-persona', persona.id)">&#x1F5D1; Eliminar</button>
                        </td>
                    </tr>
                </tbody>
            </table>
...
const emit = defineEmits(['actualizar-persona', 'delete-persona']); // Falta en tu código
...
const guardarPersona = (persona) => {
    ...
    emit('actualizar-persona', persona);
    editando.value = null;
};
</script>
